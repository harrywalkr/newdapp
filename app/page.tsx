    ...
    try {
        ...
        return (
            <div className="w-full">
                ...
                <Link target="_blank" href='https://app.galxe.com/quest/RxeSqDQ5wdkTTK8XF7wHXD/GC9TLtkWJ5' className="fixed flex items-center justify-center w-full py-2 font-semibold text-center text-lg md:text-xl bottom-0 left-0 right-0 bg-[#04049e]">
